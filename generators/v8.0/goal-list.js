...
bingoList[1] = [
  ...
  },
  {
    ...
    jp: 'スタルキッド撃破',
    types: ["skullkid", "forest"],
    child: "no"
  },
  {
    name: "Map & Compass in Dodongo's Cavern",
    jp: 'ドドンゴの洞窟のマップとコンパス',
    types: ["dc", "dungeon_item"],
    child: "yes"
  },
  {
    name: "Adult's Wallet",
...
bingoList[2] = [
  ...
  },
  {
    name: "Giant's Knife",
    jp: '巨人のナイフ',
    types: ["sets", "wallet", "dmc"],
    child: "no"
  },
  {
    name: "Bomb Bag (30)",
    jp: 'ボム袋(30)',
    types: ["bombbag", "dc", "atrade"],
    child: "yes"
  },
  {
...
bingoList[4] = [
  ...
  },
  {
    ...
    types: ["dmc", "fire", "hearts"],
    child: "yes"
  },
  {
    name: "Ice Arrows",
    jp: '氷の矢',
    types: ["fortress", "quiver", "water"],
    child: "yes"
  },
  {
    name: "Map & Compass in Shadow Temple",
    jp: '闇の神殿のマップとコンパス',
    types: ["shadow", "dungeon_item"],
    child: "yes"
  },
  {
...
bingoList[5] = [
  ...
  },
  {
    name: "Milk",
    jp: 'ロンロン牛乳',
    types: ["lonlon", "zl", "bottle"],
    child: "yes"
  },
  {
    name: "Blue Fire",
    jp: '青い炎',
    types: ["ice", "bottle", "deku", "ganon"],
    child: "yes"
  },
  {
    name: "Defeat a White Wolfos",
    jp: 'ホワイトウルフォス撃破',
    types: ["ice", "fortress", "ganon"],
    child: "yes"
  },
  {
...
bingoList[7] = [
  {
    name: "6 Hearts",
    jp: 'ハート6つ',
    types: ["hearts", "barinade", "pganon", "volvagia", "morpha", "bongo", "twinrova"],
    child: "yes"
  },
  {
  ...
  },
  {
    ...
    jp: '水の神殿のボス部屋のカギ',
    types: ["water", "fortress", "dungeon_item"],
    child: "no"
  },
  {
...
bingoList[10] = [
  ...
  },
  {
    ...
    types: ["jabu", "dungeon_item"],
    child: "yes"
  },
  {
    name: "Forest Medallion",
    jp: '森のメダル',
    types: ["forest", "lightarrow", "atrade", "pganon"],
    child: "yes"
  },
  {
    name: "Defeat Morpha",
...
bingoList[12] = [
  ...
  },
  {
    ...
    jp: '水のメダル',
    types: ["water", "lightarrow", "atrade", "morpha"],
    child: "no"
  },
  {
    name: "Gerudo's Card",
...
bingoList[13] = [
  ...
  },
  {
    ...
    jp: '森の神殿のマップとコンパス',
    types: ["forest", "quiver", "dungeon_item"],
    child: "no"
  }
];
bingoList[14] = [
  ...
  {
    name: "Bombchu Bowling Heart Piece",
  ...
  },
  {
    ...
    jp: '森の神殿のボス部屋のカギ',
    types: ["forest", "dungeon_item", "claimcheck", "quiver"],
    child: "no"
  },
  {
...
bingoList[15] = [
  ...
  },
  {
    name: "6 Maps",
    jp: 'マップ6つ',
    types: ["dungeon_item", "claimcheck", "ice"],
    child: "yes"
  },
  {
...
bingoList[16] = [
  ...
  },
  {
    name: "Saria's Song",
    jp: 'サリアの歌',
    types: ["strength", "masks", "songs", "zl", "saria"],
    child: "yes"
  },
  {
    name: "8 Hearts",
...
bingoList[18] = [
  ...
  },
  {
    name: "Fire Arrow",
    jp: '炎の矢',
    types: ["water", "firearrow", "quiver"]
  },
  {
    name: "Defeat Bongo-Bongo",
    jp: 'ボンゴボンゴ撃破',
    types: ["shadow", "zl", "deku", "bongo"],
    child: "no"
  }
];
bingoList[19] = [
  ...
  },
  {
    name: "6 Compasses",
    jp: 'コンパス6つ',
    types: ["dungeon_item", "ice"],
    child: "yes"
  },
  {
    name: "Beat the Fire Temple",
    jp: '炎の神殿クリア',
    types: ["fire", "forest", "volvagia"],
    child: "no"
  },
  {
    name: "Goron Bracelet",
...
bingoList[20] = [
  ...
  },
  {
    ...
    jp: '迷いの森のハートのかけら２つ',
    types: ["strength", "masks", "songs", "zl", "hearts"],
    child: "yes"
  },
  {
...
bingoList[21] = [
  {
    name: "Spooky Mask",
    jp: 'こわそなお面',
    types: ["masks", "strength", "zl", "fortress", "saria", "beans"],
    child: "yes"
  },
  {
  ...
  {
    name: "8 unused keys in Gerudo Training Grounds",
    jp: 'ゲルドの修練場の未使用のカギ8つ',
    types: ["fortress", "water"],
    child: "no"
  }
];
bingoList[22] = [
  {
    ...
    jp: '盾3種類と靴3種類',
    types: ["sets", "spirit", "ice"],
    child: "yes"
  },
  {
    name: "9 Hearts",
    jp: 'ハート9つ',
    types: ["hearts", "saria", "barinade", "pganon", "volvagia", "morpha", "bongo", "twinrova"],
    child: "yes"
  },
  {
...
bingoList[23] = [
  ...
  },
  {
    ...
    jp: '魂の神殿のボス部屋のカギ',
    types: ["spirit", "lightarrow", "zl", "dungeon_item"],
    child: "no"
  },
  {
    name: "7 Compasses",
...
bingoList[25] = [
  ...
  {
    name: "Get to the end of the Forest Trial",
    jp: '森の結界の最後の部屋に到達',
    types: ["ganon", "zl", "firearrow"],
    child: "yes"
  },
  {
